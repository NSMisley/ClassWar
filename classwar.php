...
if ($useragent == "CLASSWAR RMB Archiver used by CHANGETHISTOYOURNATION") {
...
$offsets = range(0, $max_rmbapi, 100);
...
file_put_contents($sql_filename, "\nALTER TABLE `rmb_archive_$region` ORDER BY `pid`;", FILE_APPEND);
?>
